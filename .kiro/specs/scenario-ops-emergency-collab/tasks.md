...
- [x] 1. 数据模型扩展与数据库迁移
  - [x] 1.1 扩展 Scenario 模型，添加场景类型和应急协同字段
  ...
  - [x] 1.3 创建 CollaborationSession 模型
  ...
  - [x] 1.4 创建 CollaborationMessage 和 CollaborationRecommendation 模型
  ...
  - [x] 1.5 扩展 SceneTrigger 模型，支持增强触发条件
...
- [x] 2. Checkpoint - 确保数据模型迁移正确
  - 确保所有测试通过，如有问题请询问用户。

- [x] 3. Schema 层实现
  - [x] 3.1 创建场景相关 Pydantic Schema
  ...
  - [x] 3.2 创建协同会话相关 Pydantic Schema
...
- [x] 5. 触发规则引擎增强
  - [x] 5.1 扩展 TriggerRuleEngine 支持增强条件
...
- [x] 6. Checkpoint - 确保触发规则引擎正确
  - 确保所有测试通过，如有问题请询问用户。

- [x] 7. 场景执行引擎实现
  - [x] 7.1 创建 ScenarioExecutionEngine 服务
...
- [x] 8. 应急协同核心服务实现
  - [x] 8.1 创建 CollaborationService 服务
...
- [x] 9. Checkpoint - 确保核心服务正确
  - 确保所有测试通过，如有问题请询问用户。

- [x] 10. 群聊管理集成
  - [x] 10.1 创建 GroupChatManager 服务
...
- [x] 11. 邮件通知服务实现
  - [x] 11.1 创建 EmailNotificationService 服务
...
- [x] 12. 消息同步服务实现
  - [x] 12.1 创建 MessageSyncService 服务
...
- [x] 13. Checkpoint - 确保集成服务正确
  - 确保所有测试通过，如有问题请询问用户。

- [x] 14. 进度分析服务实现
  - [x] 14.1 创建 ProgressAnalyzer 服务
    - 在 `server/src/services/progress_analyzer.py` 中创建新文件
    - 实现定期分析协同会话消息和操作记录
    - 集成 LLM 服务进行智能分析
    - _Requirements: 10.1_

  - [x] 14.2 实现关键事件识别和进度摘要
...
- [x] 15. 建议引擎实现
  - [x] 15.1 创建 RecommendationEngine 服务
...
- [x] 16. Checkpoint - 确保分析和建议服务正确
  - 确保所有测试通过，如有问题请询问用户。

- [x] 17. API 层实现 - 场景管理
  - [x] 17.1 创建场景 CRUD API
...
- [x] 20. Checkpoint - 确保 API 层正确
  - 确保所有测试通过，如有问题请询问用户。

- [x] 21. 集成与端到端测试
  - [x] 21.1 实现场景执行与协同会话集成
