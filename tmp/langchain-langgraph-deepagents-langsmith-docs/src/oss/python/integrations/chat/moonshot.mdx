...
This guide provides a quick overview for getting started with Moonshot AI [chat models](/oss/langchain/models). For the latest package details, examples, and source, see the [`langchain-moonshot` repository](https://github.com/ArcadiaLin/langchain-moonshot).
